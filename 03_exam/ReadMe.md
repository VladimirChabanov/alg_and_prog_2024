...
$$Б_{тесты} = 12 \cdot \frac{1}{6} \sum_{i=1}^{6}\frac{тест_i}{100}$$
...
$$Б_{проект} = 14 \cdot \frac{проект}{100}$$
...
Тестирование состоит из 100 вопросов по 1 баллу за каждый вопрос. На тестирование отводится 1 час 30 минут.
...
Вопросы по теории выбираются обучающимся случайным образом во время выбора билета (в одном билете сразу 2 вопроса).
